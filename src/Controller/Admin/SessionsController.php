...
class SessionsController extends AppController
{
    ...
    public function beforeFilter(Event $event)
    {
     ...
     public function index($type=null)
     {
       $this->isAuthorized($this->Auth->user());
        ...
        $list = $this->paginate($this->Sessions->find('all',['conditions'=>$conditions,'contain'=>['Courses','SessionClasses']]));
    ...
    public function delete($id)
    {
        ...
        $id = $this->mydecode($id);
        $c = $this->Sessions->get($id);
        if($this->Sessions->delete($c))
        {
            $this->SessionClasses->deleteAll(['session_id'=>$id]);
