            ...
            <div class="edit-profile loginform">
                ...
                <div class="form-group ">
                    <div class="col-md-6 col-sm-6 ">
                        <?= $this->Form->input('fname',['label'=>'First Name','class'=>'form-control'])?>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <?= $this->Form->input('lname',['label'=>'Last Name','class'=>'form-control'])?>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-6 col-sm-6">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6">
                        <?= $this->Form->input('country_id',['options'=>$countries,'class'=>'form-control','empty'=>'Select Country'])?>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <?= $this->Form->input('state_id',['options'=>$states,'class'=>'form-control','empty'=>'Select State'])?>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-6 col-sm-6">
                        <?= $this->Form->input('city_id',['options'=>$cities,'class'=>'form-control','empty'=>'Select City'])?>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <?= $this->Form->input('street',['class'=>'form-control'])?>
                    </div>
                </div>
                <div class="form-group">
