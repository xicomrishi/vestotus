                        ...
                        <div class="widget custom-widget clearfix">
                            <div class="customwidget text-left w40">
                                ...
                                <div class="row">
                                    ...
                                    <?php if($next) : ?>
                                    <div class="col-md-6">
                                        <a href="javascript:void(0);" onclick="gotonext1('<?= $next?>');" class="btn btn-primary btn-block">Save and Next </a>
                                    </div>
                                <?php endif; ?>
                                <?php if(!$next): ?>
                                  <div class="col-md-6">
                                        <a href="javascript:void(0);" onclick="testsubmit1('<?= $testid ?>');" class="btn btn-primary btn-block">Submit Test</a>
                                    </div>  
