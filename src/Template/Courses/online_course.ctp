...
<li role="presentation" class="active"><a tab="tab1" class="<?= $class ?>"><i class="fa fa-graduation-cap"></i> General</a></li>
...
<button class="addlrobj button button--wayra" type="button" data-toggle="modal" data-target="#myModal">Add Learning Object <i class="fa fa-plus" aria-hidden="true"></i> </button>
</div>
</div>
</div>
...
<input type="hidden" class="is_deleted_course" value="<?= $course['is_deleted'] ?>">