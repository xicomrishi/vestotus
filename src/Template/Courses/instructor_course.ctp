                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="tab-first">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation"><a id="tab2"><i class="fa fa-university"></i> Sessions </a></li>
                                        ...
                                        <div class="bottom-form">
                                            <div class="border-box">
                                                <div class="form-sec">
                                                    ...
                                                    <button class="button button--wayra" type="button" style="width:100%;" onclick="showsessionpopup();" data-toggle="modal" data-target="#sessionModel">Add Session  <i class="fa fa-plus" aria-hidden="true"></i> </button>
                                                </div>
                                            </div>
                                        </div>
...
<?= $this->Html->script('instructorCourse.js') ?>
