        ...
        <div class="tablediv quiz-wrapper">
            ...
            <table class="resulttbl">
                ...
                <tr>
                    <td><?= $ques['question'] ?> </td>
                    <td><?php 
                            if($ques['onlinetest']['answerbyuser']) { 
                                echo $ques['onlinetest']['answerbyuser']; 
                            } else { 
                                echo "NULL"; 
                            } ?> 
                    </td>
                    <td class="status">
                        <?php 
                            if($ques['onlinetest']['status']== 0 || !$ques['onlinetest']) { ?>
                        ...
                        <?php } else if($ques['onlinetest']['status']== 1) { ?> 
                            <span class="red"> <a href="#" class="btn btn-success"> <i class="fa fa-thumbs-up" aria-hidden="true"></i></a> </span>
                        <?php } ?>
                    </td>
                    <?php } ?>
                </tr>
                <tr>
                    ...
                    <td class="text-center"><?php echo ucfirst($getresult['result']) ?></td>
                </tr>
                <tr>
                    <td colspan="2">
                        Total Percentage :
