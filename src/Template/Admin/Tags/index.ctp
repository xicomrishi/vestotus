                ...
                <div class="x_panel">
                 ...
                 $i = 1;
                  ...
                  <tr role="row" class="<?= $cl ?>" id="<?= $list['id']?>">
                          ...
                          ?>
                            <?= $this->Html->link('<i class="fa fa-pencil"></i> Edit',['action'=>'form',$lid],['escape'=>false,'class'=>'btn btn-info btn-xs']) ?>
