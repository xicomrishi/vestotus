<?php $this->assign('title','Purchase History') ?>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" role="grid" >
                      <thead>
                        ...
                        <th class="" ><?= $this->Paginator->sort('Users.fname',__('Purchased By <i class="fa fa-arrow-'.$arrow.' aria-hidden="true"></i>'),['escape'=>false]) ?></th>
                        ...
                        <th class="" ><?= $this->Paginator->sort('PurchasedCourses.created',__('Purchased Date <i class="fa fa-arrow-'.$arrow.' aria-hidden="true"></i>'),['escape'=>false]) ?></th>
                  ...
                  <tr role="row" class="<?= $cl ?>" id="<?= $list['id']?>">
                          <td> 
                            <?php if($list['user']['avatar']) { echo $this->Html->image(AVATAR.$list['user']['avatar'],['width'=>'50px']); } else { // echo '<i class="fa fa-user" aria-hidden="true" style="font-size:45px;"></i>';
                              ...
                              <br> <b> Role  :  <?php if($list['user']['role'] == 2) { echo "Manager"; } else { echo "Driver";}  ?></b>
                          </td>     
                          <td>
                          ...
                          <td>
                                <?= $this->Html->link('See Enrollments',['action'=>'enrollments',$course_id]) ?>
