...
<?= '&nbsp'.$this->Html->link('<i class="fa fa-key" aria-hidden="true"></i>','javascript:void(0);',['class'=>'sharekeybutton','escape'=>false,'id'=>$list['id']]) ?>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#shareKeyform').click(function(){
		      var shareKey= $(this).attr('id');
