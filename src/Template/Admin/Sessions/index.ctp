...
<!--  <div class="row mtop15">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Manage Sessions  <small> List</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li> <?= $this->Html->link('<i class="fa fa-plus"></i> Add Session',['action'=>'form'],['escape'=>false,'class'=>'btn btn-primary','style'=>'color:#fff;']) ?></li>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" role="grid" >
                      <thead>
                        ...
                        <th class="" ><?= $this->Paginator->sort('Course.name',__('Course <i class="fa fa-arrow-'.$arrow.' aria-hidden="true"></i>'),['escape'=>false]) ?></th>
                 ...
                 $i = 1;
                  ...
                  <tr role="row" class="<?= $cl ?>" id="<?= $list['id']?>">
                          ...
                          <td>
                            <?php foreach($list['session_classes'] as $class)
                            {
                              echo $class['start_date']->format('Y M, d').' '.$class['start_time'];
                              echo " - ";
                              echo $class['end_date']->format('Y M, d').' '.$class['end_time'];
                              echo "<br>";
                            }?>
                          </td>
                          <td>
