...
<!--  <div class="row mtop15">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Manage Venues  <small> List</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li> <?= $this->Html->link('<i class="fa fa-plus"></i> Add Venue',['action'=>'form'],['escape'=>false,'class'=>'btn btn-primary','style'=>'color:#fff;']) ?></li>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" role="grid" >
                      <thead>
                        ...
                        <th class="" ><?= $this->Paginator->sort('max_class_size',__('Class Size <i class="fa fa-arrow-'.$arrow.' aria-hidden="true"></i>'),['escape'=>false]) ?></th>
                        ...
                        <th class="" ><?= $this->Paginator->sort('Users.fname',__('Manager <i class="fa fa-arrow-'.$arrow.' aria-hidden="true"></i>'),['escape'=>false]) ?></th>
                        <th>Actions </th></tr>
                      </thead>
