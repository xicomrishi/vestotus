<?php $this->assign('title',"Update Instructor Led Course") ?>
<div class="vestotus-updates">
    <div class="page-title">
        <div class="title_left">
            <h3>Manage Instructor Led Courses</h3>
        </div>
    </div>
                ...
                <div class="x_content">
                    <div class="tab-first">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a tab="tab1" <?php if($formtype == 'edit') { ?> href="#general" aria-controls="general" role="tab" data-toggle="tab" aria-expanded="true" <?php } ?>><i class="fa fa-graduation-cap"></i> General</a></li>
                            <li role="presentation"><a id="tab2" <?php if($formtype == 'edit') { ?> href="#syllabus" aria-controls="syllabus" role="tab" data-toggle="tab" aria-expanded="true" <?php } ?>><i class="fa fa-university"></i> Sessions </a></li>
                            <li role="presentation"><a id="tab3" <?php if($formtype == 'edit') { ?> href="#availability" aria-controls="availability" role="tab" data-toggle="tab" aria-expanded="true" <?php } ?>><i class="fa fa-home"></i> Availability</a></li>
                            <li role="presentation"><a id="tab4" <?php if($formtype == 'edit') { ?> href="#competetion" aria-controls="competetion" role="tab" data-toggle="tab" aria-expanded="true" <?php } ?>><i class="fa fa-check-circle-o" aria-hidden="true"></i> Completion </a></li>
                            <li role="presentation"><a id="tab5" <?php if($formtype == 'edit') { ?> href="#messages" aria-controls="messages" role="tab" data-toggle="tab" aria-expanded="true" <?php } ?>></i> Messages</a></li>
                            <li role="presentation"><a id="tab6" <?php if($formtype == 'edit') { ?> href="#resources1" aria-controls="resources1" role="tab" data-toggle="tab" aria-expanded="true" <?php } ?>><i class="fa fa-cog" aria-hidden="true"></i> Resources </a></li>
                            <li role="presentation"><a id="tab7" <?php if($formtype == 'edit') { ?> href="#complete" aria-controls="complete" role="tab" data-toggle="tab" aria-expanded="true" <?php } ?>><i class="fa fa-cog" aria-hidden="true"></i> Complete </a></li>
                        </ul>
                                                ...
                                                <table class="table table-bordered" id="chapterstbl">
                                                    <tbody class="connectedSortable">
                                                        ...
                                                        <tr id="tr_<?= $session['id'] ?>" >
                                                            <td>
                                                                <a href="#"><?= ucwords($session['title']) ?></a>
                                                            </td>
                                                            <td class="actions">
                                                                <a href="javascript:void(0);" class="delete delete_chapter" onClick="edit_session('<?= $this->Common->myencode($session['id']) ?>')"> <i class="fa fa-edit" aria-hidden="true"></i> </a>
                                                                <a href="javascript:void(0);" class="delete delete_chapter" onClick="delete_session(<?= $session['id'] ?>)"> <i class="fa fa-trash-o" aria-hidden="true"></i> </a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                            $i++;
                                                            ...
                                                            ?>
                                                        <tr id="nosession">
                                                            <td clospan="2"> No Sessions</td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
                                                <button class="button button--wayra add-learning-objects addrule" type="button" style="width:100%;" onclick="showsessionpopup();" data-toggle="modal" data-target="#sessionModel">Add Session  <i class="fa fa-plus" aria-hidden="true"></i> </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="loginform available-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="inner-section enrollment" id="enrollment_inner" <?php if($course['automatic_enrollment'] == 1) { echo "style='display:block;'"; } ?>>
                                                ...
                                                <button class="button button--wayra col-md-12 addrule add-learning-objects" id="add_rule" type="button">Add Rule <i class="fa fa-plus" aria-hidden="true"></i> </button>
                                            </div>
                                        </div>
...
<?= $this->Html->script('../admin/js/instructorCourse.js') ?>
