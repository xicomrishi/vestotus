<?php $this->assign('title','Manage Faqs') ?>
...
<?= $this->Html->css('../admin/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css')?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Faqs  <small>List</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li> <?= $this->Html->link('<i class="fa fa-plus"></i> Add New',['action'=>'addFaq'],['escape'=>false,'class'=>'btn btn-primary','style'=>'color:#fff;']) ?></li>
                 ...
                 $i = 1;
                  ...
                  <tr role="row" class="<?= $cl ?>">
                          ...
                          <td><?= $this->Html->link('Edit',['action'=>'addTestimonials',$list['id']]) ?></td>
