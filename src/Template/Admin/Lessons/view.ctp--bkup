                            ...
                            <div class="quiz-wrapper">
                                ...
                                <?php if($lesson['type']=='video') { ?>
                                    ...
                                    <video width="800" height="500" controls>
                                      <source src="<?= CHAPTER_VIDEO.$lesson['files']?>" type="video/mp4">
                                    </video>
                                <?php } else if($lesson['type']=='audio') { ?>
                                    <audio width="800" height="500" controls>
                                      <source src="<?= CHAPTER_AUDIO.$lesson['files']?>" type="audio/mpeg">
                                    </audio>
                                <?php } else if($lesson['type']=='ppt') { ?>
                                  <?= $this->Html->link($this->Html->image('ppticon.png'),CHAPTER_PPT.$lesson['files'],['escape'=>false,'target'=>'_blank'])?>
                                <?php }else if($lesson['type']=='assesment') { ?>
