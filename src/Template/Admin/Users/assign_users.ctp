<!-- <div class="">
    ...
    <div class="row"> -->
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Assign Users <small> Assign Learners To A Manager </small></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <?= $this->Form->create($userData,['type' =>'file','novalidate'=>'novalidate','class'=>'form-horizontal form-label-left']); ?>
            <?php $this->Form->templates($form_templates['fullForm']); ?>
               <div class=" item form-group">
              <label for="exampleInputPassword1">Select Learner Users</label>
              <?php  echo $this->Form->input('assigned_ids', 
                            array(
                                'type' => 'select', 
                                "multiple" => true, 
                                'label' => false, 
