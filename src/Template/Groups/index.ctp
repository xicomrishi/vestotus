...
<li class="active"><a href="<?= BASEURL?>Groups/">Groups</a></li>
...
<?= $this->Html->link('Add Group',['controller'=>'Groups','action'=>'form'],['class'=>'btn btn-primary btn-square']) ?>
<br><br>
<table class="table">
<thead>
<tr>
...
<td><?php 
$users = explode(',',$list['users']);
echo count($users);

?> </td>
<td><?= ucfirst($list['behaviour']); ?></td>
