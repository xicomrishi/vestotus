                ...
                <div class="pull-right hidden-xs">
                    <div class="bread">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?= BASEURL?>departments/">Departments</a></li>
                        </ol>
                    </div>
                    <!-- end bread -->
                </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= ucfirst($list['department']['title']) ?></td>
                                        <td><?= (isset($list['department']['parent_category'])) ? $list['department']['parent_category']['title'] : 'N/A' ?></td>
