...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/about-us', ['controller' => 'Pages', 'action' => 'view','about','prefix'=>false]);
    $routes->connect('/terms-conditions', ['controller' => 'Pages', 'action' => 'view','terms-conditions','prefix'=>false]);
    $routes->connect('/privacy-policy', ['controller' => 'Pages', 'action' => 'view','privacy-policy','prefix'=>false]);
    $routes->connect('/legal', ['controller' => 'Pages', 'action' => 'view','legal','prefix'=>false]);
    $routes->connect('/faqs', ['controller' => 'Pages', 'action' => 'faqs','prefix'=>false]);
    $routes->connect('/busses', ['controller' => 'Pages', 'action' => 'view','busses','prefix'=>false]);
    $routes->connect('/taxies', ['controller' => 'Pages', 'action' => 'view','taxies','prefix'=>false]);
    $routes->connect('/limousine', ['controller' => 'Pages', 'action' => 'view','limousine','prefix'=>false]);
