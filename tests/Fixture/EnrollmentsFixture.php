...
class EnrollmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'enroll_method' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'comment' => '1 = direct enrollment , 2 = enrolled by key , 3 = enrolled by rule of course', 'precision' => null],
        '_constraints' => [
